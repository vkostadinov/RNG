...
<body>
<img src="trivago%20icon.jpg" class="img-rounded" alt="Cinque Terre" width="104" height="106">
<h1 id="trvBlue">Random</h1>
<h1 id="trvOrange">Partner</h1>
<h1 id="trvRed">Auditor</h1>
<hr>

<h2 align="center">Click to generate a random partner and locale to test!</h2>
<form align="center" action="randomalgV3.php" method="POST">
